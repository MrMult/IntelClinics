...
(function($, window, document, undefined) {
    ...
    Video.prototype.loadVideo = function(src, addClass, noposter, index, html) {
        ...
        if (isVideo.youtube) {
            ...
            video = '<iframe class="lg-video-object lg-youtube ' + addClass + '" width="560" height="315" src="//web.archive.org/web/20231215191059/http://www.youtube.com/embed/' + isVideo.youtube[1] + a + '" frameborder="0" allowfullscreen></iframe>';
            ...
            video = '<iframe class="lg-video-object lg-vimeo ' + addClass + '" width="560" height="315"  src="//web.archive.org/web/20231215191059/http://player.vimeo.com/video/' + isVideo.vimeo[1] + a + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
            ...
            video = '<iframe class="lg-video-object lg-dailymotion ' + addClass + '" width="560" height="315" src="//web.archive.org/web/20231215191059/http://www.dailymotion.com/embed/video/' + isVideo.dailymotion[1] + a + '" frameborder="0" allowfullscreen></iframe>';
            ...
            video = '<iframe class="lg-video-object lg-vk ' + addClass + '" width="560" height="315" src="https://web.archive.org/web/20231215191059/https://vk.com/video_ext.php?' + isVideo.vk[1] + a + '" frameborder="0" allowfullscreen></iframe>';
...
/*
     FILE ARCHIVED ON 19:10:59 Dec 15, 2023 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  esindex: 0.013
  cdx.remote: 6.859
  LoadShardBlock: 161.197 (3)
  PetaboxLoader3.datanode: 331.646 (4)
  PetaboxLoader3.resolve: 191.818 (2)
  load_resource: 366.924
*/